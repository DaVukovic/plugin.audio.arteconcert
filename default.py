...
class arteMusic(libarte.libarte):
	...
	def libArteListMain(self):
		...
		#l.append({'metadata':{'name':'test'}, 'params':{'mode':'libArteListShows','uri':'ARTE_CONCERT'}, 'type':'dir'})
		#l.append({'metadata':{'name':'test2'}, 'params':{'mode':'libArteListData','code':'ARTE_CONCERT'}, 'type':'dir'})
...
#code":{"name":"popular_ARTE_CONCERT","id":null},"title":"Popular","description":null,"displayOptions":{"zoneLayout":"horizontal","itemTemplate":"landscape","theme"